...
OUTPUT=/media/jz08/HDD/zhouzy/model_param/local_debug/chatvla_stage_2_llllora
PRETRAIN=/media/jz08/HDD/zhouzy/model_param/local_debug/chatvla_lora/checkpoint-5 # your stage-1 weights
