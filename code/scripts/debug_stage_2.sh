...
MNOP=/media/jz08/HDD/zhouzy/model_param/local_debug/chatvla/checkpoint-5 # your stage-1 weights
OUTPUT=/media/jz08/HDD/zhouzy/model_param/local_debug/chatvla_stage_2
...
deepspeed --master_port 29608 --num_gpus=2 --num_nodes=1 ./train_vla.py \
